    ...
    Public Class ClientReturnPointsButton
        ...
        Public Structure ChampionSelect
            ...
            Public Structure Small
                ...
                Public Const X As Double = ClientSize.Small.Width / 1027
            ...
            Public Structure Medium
                ...
                Public Const X As Double = ClientSize.Medium.Width / 1027
            ...
            Public Structure Large
                ...
                Public Const X As Double = ClientSize.Large.Width / 1027
